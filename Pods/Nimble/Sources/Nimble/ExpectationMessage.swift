...
extension FailureMessage {
    ...
    public class NMBExpectationMessage: NSObject {
        ...
        public func toSwift() -> ExpectationMessage { return msg }
    }
